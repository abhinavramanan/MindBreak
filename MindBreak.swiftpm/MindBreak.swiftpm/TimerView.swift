...
struct TimerView: View {
    ...
    var body: some View {
        VStack {
            ...
            // Button to show/hide games list
            Button {
                ...
                HStack {
                    ...
                    Text(showingGamesList
                         ? "Swipe down or click here to go back to the timer!"
                         : "Swipe up or click here to break or improve cognition!")
                    Spacer()
                }
                .padding(8)
    ...
    /// Drag gesture to set the timer if it's not running
    ...
    /// Update endTime based on the current remainingTime
    ...
    /// Converts drag points to angles
