...
struct QuickMathGameView: View {
    ...
    var body: some View {
        ...
        .keyboardShortcut(.defaultAction) // Allows Cmd+Enter to submit on macOS
        .keyboardShortcut(.escape)        // Allows Esc to cancel/dismiss
    }
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            TextField("Enter answer", text: $userAnswer)
                ...
                .cornerRadius(16)
            // Pressing Enter/Return will submit
                .onSubmit {
                    onSubmit()
                }
                .toolbar {
